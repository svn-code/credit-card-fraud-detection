...
st.markdown("""Use this app to check if a credit card transaction is fraudulent based on 28 PCA components and scaled Time and Amount features.""")
...
# Footer
st.markdown("---")
st.markdown("Made with ❤️ using Streamlit for Credit Card Fraud Detection")
